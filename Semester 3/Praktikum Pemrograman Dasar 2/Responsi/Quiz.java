...
public class Quiz {
    ...
    public static void main(String[] args) {
        ...
        Hashtable<Integer, Quiz> bank = new Hashtable<>();
        ...
        cek = false;
        char ulang = 0;
        bank.put(1, new Quiz("Berapa harga buku?", 3000));
        bank.put(2, new Quiz("Berapa harga penghapus?", 1000));
        bank.put(3, new Quiz("Berapa harga pensil?", 2000));
        bank.put(4, new Quiz("Berapa harga bulpoin?", 3500));
        bank.put(5, new Quiz("Berapa harga rautan?", 6000));
        bank.put(6, new Quiz("Berapa harga stipo?", 5000));
        bank.put(7, new Quiz("Berapa harga penggaris?", 2500));
        bank.put(8, new Quiz("Berapa harga staples?", 8000));
        bank.put(9, new Quiz("Berapa harga spidol?", 4000));
        bank.put(10, new Quiz("Berapa harga binder?", 10000));
        do {
